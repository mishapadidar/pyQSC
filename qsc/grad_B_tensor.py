...
def calculate_grad_grad_B_tensor_vac(self, two_ways=False):
    """
    Compute the `vacuum` components of the grad grad B tensor.
    ...
    d_X1c_d_varphi = s.d_X1c_d_varphi
    d_Y1s_d_varphi = s.d_Y1s_d_varphi
    d_Y1c_d_varphi = s.d_Y1c_vac_d_varphi

    d_X20_d_varphi = s.d_X20_vac_d_varphi
    d_X2s_d_varphi = s.d_X2s_vac_d_varphi
    d_X2c_d_varphi = s.d_X2c_vac_d_varphi

    d_Y20_d_varphi = s.d_Y20_vac_d_varphi
    d_Y2s_d_varphi = s.d_Y2s_vac_d_varphi
    d_Y2c_d_varphi = s.d_Y2c_vac_d_varphi

    d_Z20_d_varphi = s.d_Z20_vac_d_varphi
    d_Z2s_d_varphi = s.d_Z2s_vac_d_varphi
    d_Z2c_d_varphi = s.d_Z2c_vac_d_varphi

    d2_X1c_d_varphi2 = s.d2_X1c_d_varphi2
    d2_Y1s_d_varphi2 = s.d2_Y1s_d_varphi2
    d2_Y1c_d_varphi2 = s.d2_Y1c_vac_d_varphi2
    d_curvature_d_varphi = s.d_curvature_d_varphi
    d_torsion_d_varphi = s.d_torsion_d_varphi
    ...
    self.grad_grad_B_vac = grad_grad_B
    ...
    self.grad_grad_B_alt_vac = grad_grad_B_alt
