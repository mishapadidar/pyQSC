...
# class ExternalSquaredFlux(Optimizable):
#     # TODO: merge this class with SquaredFlux
#     def __init__(self, bs, stel, r, ntheta=64):
#         """
#         Compute the squared flux of the coil field on a flux surface,
#             J = (1/2) int ((Bplasma + Bcoil) * nhat)^2 dA / int |Bplasma + Bcoil|^2 dA
