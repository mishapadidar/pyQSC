...
def grad_B_external_on_axis_taylor(self, r=0.1, ntheta=256, nphi=1024, ntheta_eval=32, X_target=[]):
...
def B_external_on_axis(self, r=0.1, ntheta=256, nphi=1024, ntheta_eval=32, X_target=[]):
    ...
    Returns:
        (tensor): (3, n) tensor of evaluations of B_external.
    """
    raise NotImplementedError("This function is deprecated. Please use B_external_on_axis_split instead.")
    if len(X_target) == 0:
...
def grad_B_external_on_axis(self, r=0.1, ntheta=256, nphi=1024, ntheta_eval=32, X_target=[]):
    ...
    Returns:
        (tensor): (3, 3, n) tensor of evaluations of B_external. 
            The gradient is a symmetric matrix at each target point.
    """
    raise NotImplementedError("This function is deprecated. Please use grad_B_external_on_axis_split instead.")
...
def build_virtual_casing_interpolants(self, r=0.1, ntheta=256, nphi=1024, ntheta_eval=32):
    ...
    """
    raise NotImplementedError("This function is deprecated. Please use build_virtual_casing_interpolants_split instead.")
    I = 0.0
    G = self.G0
    if self.order != 'r1':
        I += r**2 * self.I2
