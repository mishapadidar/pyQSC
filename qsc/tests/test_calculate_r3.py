...
def test_calculate_r3_vac():
    ...
    for name in names:
        stel = Qsc.from_paper(name, I2 = 100.0, p2=-1e5, order='r3')
        ...
        assert torch.allclose(stel_vac.X3c1_vac_untwisted, stel_vac.X3c1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Y3c1_vac_untwisted, stel_vac.Y3c1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Y3s1_vac_untwisted, stel_vac.Y3s1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.X3s1_vac_untwisted, stel_vac.X3s1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.X3s3_vac_untwisted, stel_vac.X3s3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.X3c3_vac_untwisted, stel_vac.X3c3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Y3c3_vac_untwisted, stel_vac.Y3c3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Y3s3_vac_untwisted, stel_vac.Y3s3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Z3s1_vac_untwisted, stel_vac.Z3s1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Z3s3_vac_untwisted, stel_vac.Z3s3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Z3c1_vac_untwisted, stel_vac.Z3c1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Z3c3_vac_untwisted, stel_vac.Z3c3_vac_untwisted, atol=1e-14)
        ...
        assert torch.allclose(stel_vac.X3c1_vac_untwisted, stel.X3c1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Y3c1_vac_untwisted, stel.Y3c1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Y3s1_vac_untwisted, stel.Y3s1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.X3s1_vac_untwisted, stel.X3s1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.X3s3_vac_untwisted, stel.X3s3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.X3c3_vac_untwisted, stel.X3c3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Y3c3_vac_untwisted, stel.Y3c3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Y3s3_vac_untwisted, stel.Y3s3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Z3s1_vac_untwisted, stel.Z3s1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Z3s3_vac_untwisted, stel.Z3s3_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Z3c1_vac_untwisted, stel.Z3c1_vac_untwisted, atol=1e-14)
        assert torch.allclose(stel_vac.Z3c3_vac_untwisted, stel.Z3c3_vac_untwisted, atol=1e-14)
